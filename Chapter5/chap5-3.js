...
if(maleDancers.count() > 0) {
	print("There are " + maleDancers.count() + " male dancers waitting to dance.");
}

if(femaleDancers.count() > 0) {
	print("There are " + femaleDancers.count() + " female dancers waitting to dance.");
}
...
There are 3 male dancers waitting to dance.
*/